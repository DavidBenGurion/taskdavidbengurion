             ...
             <div className="mx-auto " style={{width:"90%"}}> 
                ...
                <div className="box-cari w-50 mx-auto py-1 bg-light px-1 ">
                    ...
                    <div className="d-inline-block" style={{width:"10%"}}>
                        <div style={{width:"fit-content",cursor:"pointer"}} className="mx-auto px-2 py-1 rounded-circle bg-danger" onClick={cariDataByTag}>
                        ...
                        <div className="w-100 my-1">
                            <div style={{width:"fit-content"}} className="px-2  position-relative">
                                 <div className="pt-1 ps-2">
                                    <div className=" px-3 rounded mt-1 fw-bold" style={{backgroundColor:"#F5F7F8",border:"2px solid #A9A9A9"}}>{cariInput.current}</div>
                                 </div>
